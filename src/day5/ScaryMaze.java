...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	ScaryMaze() throws Exception {
		...
		AudioClip start = JApplet.newAudioClip(getClass().getResource("347911__reasanka__scary-crying-sound-effect-1-mien.wav"));
		start.play();
...
int backgroundColor=-16777216;
	...
	private void scare() {
		...
		AudioClip sound = JApplet.newAudioClip(getClass().getResource("135500__compusician__halloween-001-wav-120b.wav"));
		...
		showScaryImage("scary-maze-game-tribute.jpg");
	}
