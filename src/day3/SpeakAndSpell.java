...
public class SpeakAndSpell {
	...
	public static void main(String[] args) {
		...
		speak("spell somthing");
		// 2. Catch the user's answer in a String
		String answer =JOptionPane.showInputDialog("spell the word you just heard");
		// 3. If the user spelled the word correctly, speak "correct"
		if(answer.equalsIgnoreCase("something")){
			speak("corrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrlrrrrrrrrrrrrect");
		}
